...
public class LineCommandExtendedTest {
	...
	public static String[][] expectedResultTC7 = { 	{POINT,CLR,CLR}, 
													{CLR,POINT,CLR}, 
													{CLR,CLR,POINT} };
	...
	public static String[][] expectedResultTC8 = { 	{CLR,CLR,POINT}, 
													{CLR,POINT,CLR}, 
													{POINT,CLR,CLR} };
	
	//TC9 short line touching edge points
	...
	//TC15 diagonal line in a filled box
	...
	//TC15 diagonal line in a filled box
	public static String[][] graphDataTC16 		= { {"K","K","K","K","K","K","K"}, 
													{"K","X","X","X","X","X","K"}, 
													{"K","X","O","O","O","X","K"}, 
													{"K","X","O","O","O","X","K"}, 
													{"K","X","O","O","O","X","K"}, 
	...
	public static String[]   argumentsTC16   	= { "2","2","7","6"}; 
	
	public static String[][] expectedResultTC16 = { {"K","K","K","K","K","K","K"}, 
													{"K",POINT,"X","X","X","X","K"}, 
													{"K","X",POINT,"O","O","X","K"}, 
													{"K","X","O",POINT,"O","X","K"}, 
													{"K","X","O",POINT,"O","X","K"}, 
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			...
			{ graphDataTC16, argumentsTC16,  expectedResultTC16, "TC16 failed"   }
		});
	}
